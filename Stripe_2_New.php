...
if (isset($pm)) {
    ...
    curl_setopt($ch2, CURLOPT_POSTFIELDS, 'name='.$name_full.'&email='.$email.'&description=phccoder&address[line1]='.$location_street.'&address[city]='.$location_city.'&address[state]='.$location_state.'&address[postal_code]='.$location_postcode.'&address[country]=US');
